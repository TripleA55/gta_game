...
let botonRegistro=document.getElementById("register-btn")
let alerta=document.getElementById("alerta")
let formulario=document.getElementById("formularioRegister")

botonRegistro.addEventListener("click",function(event){
    event.preventDefault()

    let name=document.getElementById("Re-name").value
